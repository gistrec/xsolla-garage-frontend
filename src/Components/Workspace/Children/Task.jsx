...
const Task = ({ id, title, bodyTask, tags, dateTarget, isNew, open }) => {
  ...
  // Задача не раскрывается по пробелу
  const checkSpace = (e) => {
    if (e.keyCode == 32)
      e.preventDefault();
  }
      ...
      <details open={open || editMode} onKeyUp={checkSpace}>
        <summary className={styles.TaskTitleContainer}>
          ...
          <div className={styles.Icons}>
            ...
            <button className={styles.IconWrapper} style={{ display: !editMode && "none" }} onClick={(e) =>
              handleClick(e)} >
