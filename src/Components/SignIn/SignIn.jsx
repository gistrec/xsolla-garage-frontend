        ...
        <div>
            <div className={styles.abstractShapes}>
                ...
                <svg position="fixed" top="0" bottom="0" left="0" right="0" viewBox="0 0 1440 996" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 996V76C30.1091 88.801 114.533 258.553 109.81 529.599C106.031 746.437 35.0289 930.882 0 996Z" fill="#747E8A" fillOpacity="0.6" />
                    <path d="M1440 163V733C1395.62 690 1333.28 591 1303.85 468C1274.43 345 1310.84 264.5 1341.76 222.5C1366.49 188.9 1417.56 168.833 1440 163Z" fill="#EB002F" fillOpacity="0.5" />
                    <path d="M1440 0H809C890 14 912 122.5 920 148C928 173.5 953.5 259 1036.5 278.5C1119.5 298 1183 278.5 1234.5 259C1286 239.5 1301.5 235 1309.5 235C1317.5 235 1378.5 217.5 1396.5 310.5C1410.9 384.9 1431.5 417.833 1440 425V0Z" fill="#0073F7" fillOpacity="0.6" />
                </svg>
            </div>
        </div>
    )
